...
class Tac3DPublisher(Node):
    ...
    def __init__(self):
        ...
        # 发布器定义
        self.publisher_positions = self.create_publisher(Cloud, 'positions_r', 10)  # P数据 (Image)
        self.publisher_displacements = self.create_publisher(Cloud, 'displacements_r', 10)  # D数据 (Image)
        self.publisher_forces = self.create_publisher(Cloud, 'forces_r', 10)  # F数据 (Image)
        self.publisher_resultant_force = self.create_publisher(Vector3, 'resultant_force_r', 10)  # Fr数据 (Vector3)
        self.publisher_resultant_moment = self.create_publisher(Vector3, 'resultant_moment_r', 10)  # Mr数据 (Vector3)
    ...
    def publish(self):
        ...
        self.sensor.calibrate('DL1-GWM0070')
